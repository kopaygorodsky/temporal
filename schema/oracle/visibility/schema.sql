-- Execution visibility table
CREATE TABLE executions_visibility (
                                       namespace_id            CHAR(64)      NOT NULL,
                                       run_id                  CHAR(64)      NOT NULL,
                                       _version                NUMBER(19)    DEFAULT 0 NOT NULL,
    ...
    -- Generated columns for predefined search attributes
    -- Using Oracle's JSON_VALUE function instead of MySQL's -> and ->> operators
                                       TemporalChangeVersion         CLOB    GENERATED ALWAYS AS (search_attributes) VIRTUAL,
                                       BinaryChecksums               CLOB    GENERATED ALWAYS AS (search_attributes) VIRTUAL,
                                       BatcherUser                   VARCHAR2(255) GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.BatcherUser' RETURNING VARCHAR2(255))) VIRTUAL,
                                       TemporalScheduledStartTime    TIMESTAMP(6) GENERATED ALWAYS AS (
                                           TO_TIMESTAMP_TZ(JSON_VALUE(search_attributes, '$.TemporalScheduledStartTime' RETURNING VARCHAR2(255)), 'YYYY-MM-DD"T"HH24:MI:SS.FFTZH:TZM')
                                           ) VIRTUAL,
                                       TemporalScheduledById         VARCHAR2(255) GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.TemporalScheduledById' RETURNING VARCHAR2(255))) VIRTUAL,
                                       TemporalSchedulePaused        NUMBER(1) GENERATED ALWAYS AS (
                                           CASE JSON_VALUE(search_attributes, '$.TemporalSchedulePaused' RETURNING VARCHAR2(5))
                                           WHEN 'true' THEN 1
                                           WHEN 'false' THEN 0
                                           ELSE NULL
                                           END
                                           ) VIRTUAL,
                                       TemporalNamespaceDivision     VARCHAR2(255) GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.TemporalNamespaceDivision' RETURNING VARCHAR2(255))) VIRTUAL,
                                       BuildIds                      CLOB GENERATED ALWAYS AS (search_attributes) VIRTUAL,
                                       TemporalPauseInfo            CLOB GENERATED ALWAYS AS (search_attributes) VIRTUAL,
                                       TemporalWorkerDeploymentVersion    VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.TemporalWorkerDeploymentVersion' RETURNING VARCHAR2(255))) VIRTUAL,
                                       TemporalWorkflowVersioningBehavior VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.TemporalWorkflowVersioningBehavior' RETURNING VARCHAR2(255))) VIRTUAL,
                                       TemporalWorkerDeployment           VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.TemporalWorkerDeployment' RETURNING VARCHAR2(255))) VIRTUAL,

                                       PRIMARY KEY (namespace_id, run_id)
);

-- Create function to handle "open" executions with NULL close_time
CREATE OR REPLACE FUNCTION get_close_time_or_max(close_time IN TIMESTAMP)
RETURN TIMESTAMP IS
BEGIN
    RETURN COALESCE(close_time, TIMESTAMP '9999-12-31 23:59:59');
END;
/
...
-- For JSON array type search attributes, create function-based indexes using JSON_EXISTS
...
-- Custom search attributes table
CREATE TABLE custom_search_attributes (
                                          namespace_id      CHAR(64)       NOT NULL,
                                          run_id            CHAR(64)       NOT NULL,
                                          _version          NUMBER(19)     DEFAULT 0 NOT NULL,
                                          search_attributes CLOB           NULL,
                                          Bool01            NUMBER(1)      GENERATED ALWAYS AS (
                                              CASE JSON_VALUE(search_attributes, '$.Bool01' RETURNING VARCHAR2(5))
                                              WHEN 'true' THEN 1
                                              WHEN 'false' THEN 0
                                              ELSE NULL
                                              END
                                              ) VIRTUAL,
                                          Bool02            NUMBER(1)      GENERATED ALWAYS AS (
                                              CASE JSON_VALUE(search_attributes, '$.Bool02' RETURNING VARCHAR2(5))
                                              WHEN 'true' THEN 1
                                              WHEN 'false' THEN 0
                                              ELSE NULL
                                              END
                                              ) VIRTUAL,
                                          Bool03            NUMBER(1)      GENERATED ALWAYS AS (
                                              CASE JSON_VALUE(search_attributes, '$.Bool03' RETURNING VARCHAR2(5))
                                              WHEN 'true' THEN 1
                                              WHEN 'false' THEN 0
                                              ELSE NULL
                                              END
                                              ) VIRTUAL,
                                          Datetime01        TIMESTAMP(6)   GENERATED ALWAYS AS (
                                              TO_TIMESTAMP_TZ(JSON_VALUE(search_attributes, '$.Datetime01' RETURNING VARCHAR2(255)), 'YYYY-MM-DD"T"HH24:MI:SS.FFTZH:TZM')
                                              ) VIRTUAL,
                                          Datetime02        TIMESTAMP(6)   GENERATED ALWAYS AS (
                                              TO_TIMESTAMP_TZ(JSON_VALUE(search_attributes, '$.Datetime02' RETURNING VARCHAR2(255)), 'YYYY-MM-DD"T"HH24:MI:SS.FFTZH:TZM')
                                              ) VIRTUAL,
                                          Datetime03        TIMESTAMP(6)   GENERATED ALWAYS AS (
                                              TO_TIMESTAMP_TZ(JSON_VALUE(search_attributes, '$.Datetime03' RETURNING VARCHAR2(255)), 'YYYY-MM-DD"T"HH24:MI:SS.FFTZH:TZM')
                                              ) VIRTUAL,
                                          Double01          NUMBER(20, 5)  GENERATED ALWAYS AS (TO_NUMBER(JSON_VALUE(search_attributes, '$.Double01' RETURNING VARCHAR2(30)))) VIRTUAL,
                                          Double02          NUMBER(20, 5)  GENERATED ALWAYS AS (TO_NUMBER(JSON_VALUE(search_attributes, '$.Double02' RETURNING VARCHAR2(30)))) VIRTUAL,
                                          Double03          NUMBER(20, 5)  GENERATED ALWAYS AS (TO_NUMBER(JSON_VALUE(search_attributes, '$.Double03' RETURNING VARCHAR2(30)))) VIRTUAL,
                                          Int01             NUMBER(19)     GENERATED ALWAYS AS (TO_NUMBER(JSON_VALUE(search_attributes, '$.Int01' RETURNING VARCHAR2(20)))) VIRTUAL,
                                          Int02             NUMBER(19)     GENERATED ALWAYS AS (TO_NUMBER(JSON_VALUE(search_attributes, '$.Int02' RETURNING VARCHAR2(20)))) VIRTUAL,
                                          Int03             NUMBER(19)     GENERATED ALWAYS AS (TO_NUMBER(JSON_VALUE(search_attributes, '$.Int03' RETURNING VARCHAR2(20)))) VIRTUAL,
                                          Keyword01         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword01' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword02         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword02' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword03         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword03' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword04         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword04' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword05         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword05' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword06         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword06' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword07         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword07' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword08         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword08' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword09         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword09' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Keyword10         VARCHAR2(255)  GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Keyword10' RETURNING VARCHAR2(255))) VIRTUAL,
                                          Text01            CLOB           GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Text01' RETURNING CLOB)) STORED,
                                          Text02            CLOB           GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Text02' RETURNING CLOB)) STORED,
                                          Text03            CLOB           GENERATED ALWAYS AS (JSON_VALUE(search_attributes, '$.Text03' RETURNING CLOB)) STORED,
                                          KeywordList01     CLOB           GENERATED ALWAYS AS (search_attributes) VIRTUAL,
                                          KeywordList02     CLOB           GENERATED ALWAYS AS (search_attributes) VIRTUAL,
                                          KeywordList03     CLOB           GENERATED ALWAYS AS (search_attributes) VIRTUAL,

                                          PRIMARY KEY (namespace_id, run_id)
);

-- Create indexes for custom search attributes
...
-- Create Oracle Text indexes for full-text search
BEGIN
    CTX_DDL.CREATE_PREFERENCE('TEXT_DATASTORE', 'DIRECT_DATASTORE');
CTX_DDL.CREATE_PREFERENCE('TEXT_LEXER', 'BASIC_LEXER');
END;
/

CREATE INDEX by_text_01 ON custom_search_attributes (Text01)
    INDEXTYPE IS CTXSYS.CONTEXT PARAMETERS ('DATASTORE TEXT_DATASTORE LEXER TEXT_LEXER');

CREATE INDEX by_text_02 ON custom_search_attributes (Text02)
    INDEXTYPE IS CTXSYS.CONTEXT PARAMETERS ('DATASTORE TEXT_DATASTORE LEXER TEXT_LEXER');

CREATE INDEX by_text_03 ON custom_search_attributes (Text03)
    INDEXTYPE IS CTXSYS.CONTEXT PARAMETERS ('DATASTORE TEXT_DATASTORE LEXER TEXT_LEXER');